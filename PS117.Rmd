...
T0_T8_FenoFe(((POC_uM)/PON_uM), POC:POM~~(M:M))# + 
                 #expand_limits(y = 0) +
                 scale_x_discrete(limits=c("T0","noFe","Fe"), 
                                  labels = c("T0", "-Fe", "+Fe"))+
                 theme(axis.title.y=element_text(size=14, color = "black")) + 
...
x <- aov (as.numeric(fract_haptophytes)~as.factor(iron_treatment)*as.factor(temperature_treatment), data = BA1)
TukeyHSD(x)
...
png("ps117_figureS_dnutrients_highres_20230516.png", width=18, height=9, units="in", res=900) 

plot_grid(dsi, NULL,  dni, NULL,  dzn, 
...
a <- ggraph(mygraph_BA1, layout = 'circlepack', weight = size) +  #weight = size adjusts the circle size
  ...
  scale_fill_manual(values=c("allproteins" = "NA",
         ...
         scale_color_manual(values=c("empty" = "NA",
                              "notempty" = "black")) +
annotate ("text", x = -0.4, y = 0.8, label = "BA1", size = 8) +                            
...
b <- ggraph(mygraph_BA2, layout = 'circlepack', weight = size) +  #weight = size adjusts the circle size
  ...
  scale_fill_manual(values=c("allproteins" = "NA",
         ...
         scale_color_manual(values=c("empty" = "NA",
                              "notempty" = "black")) +
annotate ("text", x = -0.4, y = 0.8, label = "BA2", size = 8) +                            
  #filter = leaf     
    geom_node_text(aes(label = proteinlabel), size = 3)+
...
#png("ps117_circlepack_20230526.png", width=17, height=9, units="in", res=600) 
