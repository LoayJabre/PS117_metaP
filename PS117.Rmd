...
png("ps117_figure1_highres_20230522.png", width= 13, height=12, units="in", res=900) 
...
#Figure circlepack map- 2023-05-25
...
#Figure for taxon-normalized major protein groups and NP-  2023-05-26
```{r}
...
#pennates
a <- grpnorm_compartment ("^chloro$", "Pennate di", "Taxon-norm photosynthetic protein (%)") +  # atop ("Pennate diatom", paste ("photosynthetic protein fraction"))) 
  ylim(0,33) + 
  theme (axis.text.x = element_blank())+
  ggtitle("Pennate diatoms")


d <- grpnorm_compartment ("^rubisco$", "Pennate di", "Taxon-norm RuBisCO protein (%)") +
  ylim(0,7) + 
  theme (axis.text.x = element_blank()) 
 

g <- grpnorm_compartment ("^ribosome$", "Pennate di", "Taxon-norm ribosomal protein (%)") +
  ylim(0,23) 
...
#png("ps117_ps117_taxonphotoriborubisco_highres_20230526.png", width=19, height=10, units="in", res=900) 
...
#Figure for sample-normalized major protein groups 2023-05-26
```{r}
...
deplot <- plot_grid(FeDE_BA1, FeDE_BA2,
          ncol = 2, 
          rel_widths = c(1,0.8), 
          labels = c("", ""))


calcs <- plot_grid (cdcacalc, NULL,  mnclustcalc, ncol = 3, rel_widths = c(1,0.03,1), labels = c("", "") )
...
```{r}
x_vs_time (Nano2_cells_mL, "Phaeo cell counts per mL") +scale_y_log10()
